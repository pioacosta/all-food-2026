...
//  de modo que el flujo puede instanciarla para cada secci?f�n.
// �????,?�????,?�????,?�????,?�????,?�????,?�????,?�????,?�????,?�????,?�????,?�????,?�????,?�????,?�????,?�????,?�????,?�????,?�????,?�????,?�????,?�????,?�????,?�????,?�????,?�????,?�????,?�????,?�????,?�????,?�????,?�????,?�????,?�????,?�????,?�????,?�????,?�????,?�????,?�????,?�????,?�????,?�????,?�????,?�????,?�????,?�????,?�????,?�????,?�????,?�????,?�????,?�????,?�????,?�????,?�????,?�????,?�????,?�????,?�????,?�????,?
...
class _CartaClientePageState extends State<CartaClientePage> {
  ...
  // En cliente usamos 3 ?f�tems por p?f�gina para evitar overflow en pantallas
  // chicas al combinar filtros + resumen + paginaci?f�n.
  ...
  Future<void> _onAgregarAlPedido(
    ...
    if (widget.mesaId == null) {
      _mostrarMensaje(
        'No hay mesa vinculada. Escane?f� el QR de mesa para pedir.',
        esError: true,
      );
      return;
    }
                              ...
                              child: Row(
                                ...
                                children: [
                                  IconButton(
                                    ...
                                    icon: Icon(
                                      Icons
                                          .chevron_left_rounded, // �???� rounded se ve m?f�s grueso
                                      color:
                                          _paginaActual == 0
                                              ? Colors.white24
                                              : Colors.white70,
                                      size: 36, // �???� m?f�s grande
                                    ),
                                  ),
                                  Text(
                                    ...
                                    style: const TextStyle(
                                      color:
                                          Colors
                                              .white70, // �???� un poco m?f�s visible
                                      fontSize: 16, // �???� m?f�s grande
                                      fontWeight:
                                          FontWeight.w800, // �???� m?f�s grueso
                                    ),
                                  ),
                                  IconButton(
                                    onPressed:
                                    ...
                                    icon: Icon(
                                      Icons
                                          .chevron_right_rounded, // �???� rounded se ve m?f�s grueso
                                      color:
                                          _paginaActual >= _totalPaginas - 1
                                              ? Colors.white24
                                              : Colors.white70,
