...
class _AsignarMesaPageState extends State<AsignarMesaPage> {
  ...
  Future<void> _asignar() async {
    if (_clienteSeleccionado == null || _mesaSeleccionada == null) {
      _mostrarMensaje('Seleccion?f� un cliente y una mesa', true);
      return;
    }
                ...
                Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(
                        _paso == 0
                            ? 'Eleg?f� el cliente a sentar'
                            : 'Eleg?f� la mesa para ${_clienteSeleccionado!['nombres']}',
                        textAlign: TextAlign.center,
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      children: [
        ...
        Text(
          'P?f�gina ${paginaActual + 1} / $totalPaginas',
          style: const TextStyle(
            color: Colors.white,
            fontWeight: FontWeight.w700,
          ),
...
class _ClienteCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final String etiquetaTexto = esAnonimo ? 'An?f�nimo' : 'Registrado';
