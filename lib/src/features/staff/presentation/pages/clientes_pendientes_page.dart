                                            ...
                                            child: Row(
                                              children: [
                                                CircleAvatar(
                                                  ...
                                                  backgroundImage: cliente['foto_url'] != null ? NetworkImage( cliente['foto_url'],): null,
                                                  child: cliente['foto_url'] == null ? const Icon(Icons.person, color: Colors.grey,): null,
                                                ),
                                                ...
                                                Column(
                                                  children: [
                                                    _ActionButton(
                                                      color: Colors.green,
                                                      icon: Icons.check,
                                                      onTap: () =>_aprobar(cliente),
                                                    ),
                                                    const SizedBox(height: 6),
                                                    _ActionButton(
                                                      color: Colors.red,
                                                      icon: Icons.close,
                                                      onTap: () => _rechazar( cliente ),
                                                    ),
                                                  ],
                                                ),
                                              ],
