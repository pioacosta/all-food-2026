...
class _LoginPageState extends State<LoginPage> {
  ...
  Future<void> _ingresar() async {
    ...
    if (!widget.supabaseReady) {
      _mostrarMensaje(
        'No hay conexi贸n a Supabase. Revisa las variables de entorno.',
        esError: true,
      );
      return;
    }
    ...
    try {
      ...
      if (response.user == null) {
        _mostrarMensaje('No fue posible iniciar sesi贸n.', esError: true);
        return;
      }
      ...
      _mostrarMensaje(
        AppErrorMapper.toUserMessage(
          error,
          fallbackMessage: 'Ocurri贸 un error inesperado al ingresar.',
        ),
        esError: true,
      );
    } finally {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      FilledButton.tonal(
                        ...
                        child: const Text('Ingresar como cliente an髇imo'),
                      ),
                      const SizedBox(height: 20),
                      Align(
                        ...
                        child: FloatingActionButton.extended(
                          ...
                          label: const Text('Ingreso r醦ido'),
                        ),
                      ),
